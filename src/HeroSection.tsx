  ...
  return (
    ...
    //   }}
      ...
      <div className=" w-[724px] h-[259px] p-6">
        <h1 className="text-[18px] leading-[24px] pb-[35px] text-secondary font-semibold">Wellcome to Muscle Max</h1>
      ...
      <div>
        <img className="object-contain" src="https://dreamthemebd.dreamitsolution.net/html/dreamhub/personal-trainer/assets/images/hero-thumb.png" alt="" />
      </div>
    </div>
  );
}
