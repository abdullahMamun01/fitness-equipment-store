...
export default function Footer() {
  return (
    <section className="py-14  bg-primary">
      <div className="container mb-4 px-4 mx-auto ">
            ...
            <div className="flex flex-wrap -mx-4 items-center">
              ...
              <div className="w-full lg:w-1/2 px-4">
                <div className="sm:flex -mb-4 items-center lg:justify-end">
                  ...
                  <a className="relative group inline-block w-full sm:w-auto py-3 px-5 mb-4 text-center text-sm font-semibold text-primary hover:text-secondary bg-secondary  rounded-md overflow-hidden transition duration-300" href="#">
          ...
          <div className="flex flex-wrap -mx-4 mb-18">
            <div className="w-full lg:w-2/5 px-4 mb-12 lg:mb-0">
              <div className="xs:max-w-xs">
                <h4 className="font-heading text-2xl font-semibold text-secondary mb-4">Subscribe to our newsletter</h4>
                <form action="">
                  <label className="block mb-1.5 text-sm font-semibold text-secondary" htmlFor="">Email</label>
                  <div className="xs:flex items-center">
                    <div className="relative mb-4 xs:mb-0 xs:mr-4">
                      ...
                      <input className="w-full p-12 pr-4 py-4 text-sm text-secondary placeholder-gray-400 rounded-lg bg-gray-800 border border-secondary outline-none" type="email" placeholder="pat@shuffle.dev" />
                    </div>
                    <button className="flex flex-shrink-0 ml-auto xs:ml-0 items-center justify-center w-12 h-12 text-primary hover:text-orange-900 bg-secondary hover:bg-white rounded-full transition duration-200" type="submit">
                      <svg className='' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
              <h5 className="text-lg font-semibold text-secondary mb-4">Services</h5>
              <ul>
                <li className="mb-4"><a className="inline-block text-secondary hover:text-gray-200" href="#">Email Marketing</a></li>
                <li className="mb-4"><a className="inline-block text-secondary hover:text-gray-200" href="#">Campaigns</a></li>
                <li className="mb-4"><a className="inline-block text-secondary hover:text-gray-200" href="#">Branding</a></li>
                <li><a className="inline-block text-secondary hover:text-gray-200" href="#">Offline</a></li>
              </ul>
            </div>
            <div className="w-full sm:w-1/3 lg:w-1/5 px-4 mb-8 sm:mb-0">
              <h5 className="text-lg font-semibold text-secondary mb-3">About</h5>
              <ul>
                <li className="mb-4"><a className="inline-block text-secondary hover:text-gray-200" href="#">Our Story</a></li>
                <li className="mb-4"><a className="inline-block text-secondary hover:text-gray-200" href="#">Benefits</a></li>
                <li className="mb-4"><a className="inline-block text-secondary hover:text-gray-200" href="#">Team</a></li>
                <li><a className="inline-block text-secondary hover:text-gray-200" href="#">Careers</a></li>
              </ul>
            </div>
            <div className="w-full sm:w-1/3 lg:w-1/5 px-4">
              <h5 className="text-lg font-semibold text-secondary mb-4">Help</h5>
              <ul>
                <li className="mb-4"><a className="inline-block text-secondary hover:text-gray-200" href="#">FAQs</a></li>
                <li><a className="inline-block text-secondary hover:text-gray-200" href="#">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div className="sm:flex items-center justify-between">
            <div className="sm:flex mb-6 sm:mb-0 items-center">
              <a className="inline-block mr-6 sm:mr-12 text-secondary hover:text-gray-200" href="#">Terms & Conditions</a>
              <a className="inline-block text-secondary hover:text-gray-200" href="#">Privacy Policy</a>
            </div>
