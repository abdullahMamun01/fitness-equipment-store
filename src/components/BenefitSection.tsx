...
const BenefitSection = () => {
  return (
    ...
    <section className="py-14  bg-gray-100">
      <h1 className="text-primary  text-3xl font-bold text-center  mb-14 uppercase">Why Choose Us?</h1>
        ...
        <div className="max-w-xs md:max-w-xl xl:max-w-6xl mx-auto">
          <div className="flex flex-wrap items-center justify-center -mx-4 -mb-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="w-full md:w-1/2 xl:w-1/4  px-4 mb-8 text-secondary ">
                <div className="flex h-18 items-center px-4 py-5 bg-primary border-2 border-primary rounded-md shadow min-h-[96px]">
